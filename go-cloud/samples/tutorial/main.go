...
import (
	...
	_ "github.com/apache/iceberg-go/go-cloud/blob/azureblob"
	_ "github.com/apache/iceberg-go/go-cloud/blob/gcsblob"
	_ "github.com/apache/iceberg-go/go-cloud/blob/s3blob"
)
