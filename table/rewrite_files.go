...
// CompactionGroupResult holds the output of a single compaction group execution.
// Distributed compaction workers produce one result per group; the leader
// feeds them into a [RewriteFiles] builder via [RewriteFiles.ApplyResult].
